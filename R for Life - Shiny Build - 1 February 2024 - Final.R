...
# CREATE CHARACTER DATABASES - RUN ME FIRST ----
...
#       UI - BATTLE ROYALE PAGE ----
tabPanel("Battle Royale",
          titlePanel("Battle Royale"), 
          sidebarLayout(
            sidebarPanel(
                 # drop down menus for selecting characters and attribute for battle royale
              div(selectInput("character1", 
